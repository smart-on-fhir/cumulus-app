    ...
    parameters: {
        ...
        encounter_type: {
            ...
            values: [
                ...
                ...[
                    { value: "108219001", label: "Physician visit with evaluation AND/OR management service (procedure)" },
                    { value: "108220007", label: "Evaluation AND/OR management - new patient (procedure)" },
                    { value: "108221006", label: "Evaluation AND/OR management - established patient (procedure)" },
                    { value: "1197766005", label: "Encounter by electronic text-based asynchronous communication (procedure)" },
                    { value: "1237136005", label: "Consultation with patient (procedure)" },
                    { value: "1258986006", label: "Face-to-face encounter (procedure)" },
                    { value: "1269515004", label: "Face to face consultation with patient (procedure)" },
                    { value: "12843005", label: "Subsequent hospital visit by physician (procedure)" },
                    { value: "14736009", label: "History and physical examination with evaluation and management of patient (procedure)" },
                    { value: "1479971000168109", label: "Email encounter (procedure)" },
                    { value: "18170008", label: "Subsequent nursing facility visit (procedure)" },
                    { value: "185317003", label: "Telephone encounter (procedure)" },
                    { value: "185318008", label: "Third party encounter (procedure)" },
                    { value: "185320006", label: "Encounter by computer link (procedure)" },
                    { value: "185321005", label: "Letter encounter to patient (procedure)" },
                    { value: "185345009", label: "Encounter for symptom (procedure)" },
                    { value: "185346005", label: "Encounter for sign (procedure)" },
                    { value: "185347001", label: "Encounter for problem (procedure)" },
                    { value: "185348006", label: "Encounter for fear (procedure)" },
                    { value: "185349003", label: "Encounter for check up (procedure)" },
                    { value: "185387006", label: "New patient consultation (procedure)" },
                    { value: "185462000", label: "Home visit request by relative (procedure)" },
                    { value: "185463005", label: "Visit out of hours (procedure)" },
                    { value: "185464004", label: "Out of hours visit - not night visit (procedure)" },
                    { value: "185465003", label: "Weekend visit (procedure)" },
                    { value: "185466002", label: "Home visit for urgent condition (procedure)" },
                    { value: "185467006", label: "Home visit for acute condition (procedure)" },
                    { value: "185468001", label: "Home visit for chronic condition (procedure)" },
                    { value: "185469009", label: "District nurse visit (procedure)" },
                    { value: "185470005", label: "Home visit elderly assessment (procedure)" },
                    { value: "19681004", label: "Nursing evaluation of patient and report (procedure)" },
                    { value: "207195004", label: "History and physical examination with evaluation and management of nursing facility patient (procedure)" },
                    { value: "209099002", label: "History and physical examination with management of domiciliary or rest home patient (procedure)" },
                    { value: "210098006", label: "Domiciliary or rest home patient evaluation and management (procedure)" },
                    { value: "225929007", label: "Joint home visit (procedure)" },
                    { value: "270424005", label: "Letter encounter from patient (procedure)" },
                    { value: "270425006", label: "Letter from specialist (procedure)" },
                    { value: "270427003", label: "Patient-initiated encounter (procedure)" },
                    { value: "270430005", label: "Provider-initiated encounter (procedure)" },
                    { value: "275693003", label: "Letter from consultant (procedure)" },
                    { value: "288836004", label: "Agreeing on elements of the care plan (procedure)" },
                    { value: "308720009", label: "Letter encounter (procedure)" },
                    { value: "310587004", label: "First annual visit by district nurse (procedure)" },
                    { value: "310588009", label: "Visit by health visitor (procedure)" },
                    { value: "314849005", label: "Telephone contact by consultant (procedure)" },
                    { value: "315205008", label: "Bank holiday home visit (procedure)" },
                    { value: "3391000175108", label: "Office visit for pediatric care and assessment (procedure)" },
                    { value: "386472008", label: "Telephone consultation (procedure)" },
                    { value: "386473003", label: "Telephone follow-up (procedure)" },
                    { value: "401267002", label: "Telephone triage encounter (procedure)" },
                    { value: "401271004", label: "Email sent to patient (procedure)" },
                    { value: "408482001", label: "District nurse follow up (procedure)" },
                    { value: "408483006", label: "District nurse initial visit (procedure)" },
                    { value: "408487007", label: "Health visitor follow up (procedure)" },
                    { value: "4141000175103", label: "Encounter for blood donation (procedure)" },
                    { value: "416520008", label: "Consultation for unaccompanied minor (procedure)" },
                    { value: "423215004", label: "Provision of continuity of care (regime/therapy)" },
                    { value: "438515009", label: "Email encounter from caregiver (procedure)" },
                    { value: "438516005", label: "Email encounter to caregiver (procedure)" },
                    { value: "439058005", label: "Home visit for care and maintenance of urinary catheter (procedure)" },
                    { value: "439708006", label: "Home visit (procedure)" },
                    { value: "439887005", label: "Home visit for mechanical ventilation care (procedure)" },
                    { value: "440068009", label: "Home visit for newborn care and assessment (procedure)" },
                    { value: "440085006", label: "Home visit for postpartum care and assessment (procedure)" },
                    { value: "440146002", label: "Home visit for care and maintenance of colostomy (procedure)" },
                    { value: "440168007", label: "Provision of copy of letter from specialist to patient (procedure)" },
                    { value: "440568002", label: "Visit with nurse at next appointment requested (procedure)" },
                    { value: "440611006", label: "Home visit for marriage counseling (procedure)" },
                    { value: "440696002", label: "Home visit for intramuscular injection (procedure)" },
                    { value: "441244001", label: "Home visit for cystostomy care and maintenance (procedure)" },
                    { value: "444971000124105", label: "Annual wellness visit (procedure)" },
                    { value: "445450000", label: "Encounter by short message service text messaging (procedure)" },
                    { value: "448337001", label: "Telemedicine consultation with patient (procedure)" },
                    { value: "452081000124104", label: "Health evaluation of new immigrant (procedure)" },
                    { value: "4525004", label: "Emergency department patient visit (procedure)" },
                    { value: "453131000124105", label: "Videotelephony encounter (procedure)" },
                    { value: "453701000124103", label: "In-person encounter (procedure)" },
                    { value: "456201000124103", label: "Medicare annual wellness visit (procedure)" },
                    { value: "461231000124109", label: "Consultation for suicide risk management (procedure)" },
                    { value: "50357006", label: "Evaluation and management of patient at home (procedure)" },
                    { value: "557761000005104", label: "E-mail consultation (procedure)" },
                    { value: "6051000124107", label: "Pharmacokinetic consultation (procedure)" },
                    { value: "6061000124109", label: "Risk evaluation and mitigation strategy consultation (procedure)" },
                    { value: "68341005", label: "Hemodialysis, supervision at home (procedure)" },
                    { value: "69399002", label: "Initial hospital visit by physician (procedure)" },
                    { value: "698704008", label: "Home visit for rheumatology service (procedure)" },
                    { value: "704126008", label: "Home visit for anticoagulant drug monitoring (procedure)" },
                    { value: "711458003", label: "Encounter for fitness for duty exam (procedure)" },
                    { value: "713776001", label: "Email encounter from third party (procedure)" },
                    { value: "719407002", label: "Remote non-verbal consultation (procedure)" },
                    { value: "719410009", label: "Consultation via video conference (procedure)" },
                    { value: "763184009", label: "Telepractice consultation (procedure)" },
                    { value: "83362003", label: "Final inpatient visit with instructions at discharge (procedure)" },
                    { value: "86013001", label: "Periodic reevaluation and management of healthy individual (procedure)" },
                    { value: "86181006", label: "Evaluation and management of inpatient (procedure)" },
                    { value: "866149003", label: "Annual visit (procedure)" },
                    { value: "868184008", label: "Telemedicine consultation with provider (procedure)" },
                    { value: "90526000", label: "Initial evaluation and management of healthy individual (procedure)" },
